...
function DropsPage() {
  ...
  useEffect(() => {
    fetchProductsByCategory("drops").then(setItems).finally(() => setLoading(false));
  }, []);
    ...
    /* @__PURE__ */ jsxs("main", { className: "flex-1 pt-[100px] md:pt-[120px]", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center relative z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "space-y-6 text-right", children: [
            /* @__PURE__ */ jsxs("div", { className: "inline-flex items-center gap-4", children: [
              ...
              /* @__PURE__ */ jsx("span", { className: "text-primary font-bold uppercase tracking-[0.5em] text-[9px] transition-colors", children: "LIMITED RELEASES" })
            ] }),
            ...
            /* @__PURE__ */ jsx("p", { className: "text-base text-foreground/80 font-light leading-relaxed max-w-md mr-0 ml-auto", children: "تحرّك في صمت. قطع محدودة الإصدار تعبر عن الهوية الحضرية التونسية. إصدارات نادرة لا تتكرر." })
          ] }),
          /* @__PURE__ */ jsx(HoverSyncWrapper, { imageUrl: heroImg, className: "h-80 rounded-container overflow-hidden shadow-2xl glass-card p-2", children: /* @__PURE__ */ jsx("img", { src: heroImg, alt: "Drops", className: "w-full h-full object-cover hover:scale-105 transition-transform duration-1000", onError: (e) => {
      ...
      /* @__PURE__ */ jsx("section", { className: "reveal py-16 bg-transparent", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-6 mb-10", children: [
          ...
          /* @__PURE__ */ jsx("h2", { className: "text-3xl font-display uppercase tracking-tight", children: "الإصدارات الحالية" }),
