...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CpEk9iTU.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-argkJYP3.js").then((n) => n.r),
...
var ROUTER_BASEPATH = "kusuf";
var SERVER_FN_BASE = "/kusuf/_serverFn/";
