...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "تواصل مع فريق Kusuf: استفسارات، دعم، أو شراكات." },
    ],
  }),
  ...
  return (
    <div dir="rtl" className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <section className="pt-[120px] md:pt-[160px] pb-16 md:pb-24 bg-gradient-to-br from-primary/10 to-secondary/5">
          <div className="max-w-4xl mx-auto px-4 text-center space-y-4">
            <h1 className="text-5xl md:text-6xl font-bold">تواصل معنا</h1>
            <p className="text-xl text-muted-foreground">
              لدينا دعم لطيف وسريع. أرسل رسالتك ونحن في الخدمة.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              {[
                ...
                { icon: Mail, label: "البريد الإلكتروني", value: "hello@Kusuf.tn" },
